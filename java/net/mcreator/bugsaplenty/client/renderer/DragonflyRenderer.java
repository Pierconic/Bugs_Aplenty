...
import net.mcreator.bugsaplenty.entity.model.DragonflyModel;
...
public class DragonflyRenderer extends GeoEntityRenderer<DragonflyEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, DragonflyEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
