...
import net.mcreator.bugsaplenty.entity.model.ButterflyModel;
...
public class ButterflyRenderer extends GeoEntityRenderer<ButterflyEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ButterflyEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
