package net.mcreator.bugsaplenty.client.gui;
...
public class TestScreen extends AbstractContainerScreen<TestMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("bugs_aplenty:textures/screens/test.png");
