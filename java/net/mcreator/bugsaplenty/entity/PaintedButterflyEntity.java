...
public class PaintedButterflyEntity extends PathfinderMob implements GeoEntity {
	...
	public PaintedButterflyEntity(EntityType<PaintedButterflyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				...
				double dir_x = PaintedButterflyEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = PaintedButterflyEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = PaintedButterflyEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = PaintedButterflyEntity.this.getX();
				double y = PaintedButterflyEntity.this.getY();
				double z = PaintedButterflyEntity.this.getZ();
				Entity entity = PaintedButterflyEntity.this;
				Level world = PaintedButterflyEntity.this.level();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(PaintedButterflyEntity.RemovalReason.KILLED);
